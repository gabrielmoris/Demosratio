...
export default function LpCard({ type }: Props) {
  ...
  return (
    <Link
      ...
      className="relative bg-contrast flex items-start justify-start flex-col text-background p-5 rounded-md font-drsans min-h-52 md:min-h-72 text-drlight hover:opacity-80 hover:-translate-y-1 w-full duration-500"
    >
