...
export default async function Manifest() {
  ...
  return (
    <main className="flex flex-col my-5 gap-8 row-start-2 items-center sm:items-start text-justify p-4">
      <h1 className="text-2xl font-drserif font-bold">{t("title")}</h1>
      <p className="text-lg">{t("intro")}</p>

      {/* Problem Section */}
      <section className="mt-4">
        <h2 className="text-xl font-semibold mb-4 font-drserif">{t("problemTitle")}</h2>
      ...
      <section className="my-4">
        <h2 className="text-xl font-semibold mb-4 font-drserif">{t("howItWorksTitle")}</h2>
        <p>{t("howItWorksDescription")}</p>
      </section>

      {/* Features Section */}
      <section className="my-4">
        <h2 className="text-xl font-semibold mb-4 font-drserif">{t("featuresTitle")}</h2>
        <ul>
      ...
      <section className="my-4">
        <h2 className="text-xl font-semibold mb-4 font-drserif">{t("personalStatementTitle")}</h2>
      ...
      {/* Goal Section */}
      <section className="my-4">
        <h2 className="text-xl font-semibold mb-4 font-drserif">{t("goalTitle")}</h2>
