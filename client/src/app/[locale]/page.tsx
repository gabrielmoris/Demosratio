...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-items-center min-h-screen p-8 pb-20 sm:p-20 font-[family-name:var(--font-roboto)]">
      <section className="flex flex-col gap-8 md:gap-32 row-start-2 items-center sm:items-start">
