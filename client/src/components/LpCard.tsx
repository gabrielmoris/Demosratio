...
export default function LpCard({ type }: Props) {
  ...
  return (
    <Link
      ...
      className="relative bg-contrast flex items-start justify-start flex-col text-background p-5 rounded-md font-[family-name:var(--font-roboto-serif)] min-h-52 min-w-80 md:min-h-64 md:min-w-96 text-drlight hover:opacity-80 hover:-translate-y-1 duration-500"
    >
